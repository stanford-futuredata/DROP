 ...
 */
public class DROPKNNWrongCostExperiments extends Experiment {
    public static String baseString = "src/main/java/experiments/WrongCostKNNExperiments/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (PCASkiingOptimizer.PCAAlgo algo : algos) {
            for (PCASkiingOptimizer.work reuse : resuseStates) {
                ...
                double[][] outputValues = new double[][]{avgDROPRuntime, avgK, avgNt, avgIters, avgKNNRuntime, avgAccuracy};
