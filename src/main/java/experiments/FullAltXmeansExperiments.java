 ...
 */
public class FullAltXmeansExperiments extends Experiment {
    public static String baseString = "src/main/java/experiments/XMeansAltExperiments/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        double[] avgPAAKXmeans = new double[numTrials];
        ...
        double[] avgFFTKXmeans = new double[numTrials];
        ...
        for (int i = 0; i < numTrials; i++) {
            ...
            XMeansClassifier = new XMeans(d, 25, propnTrain);
            ...
            avgPAAKXmeans[i] = XMeansClassifier.getK();
            ...
            avgFFTKXmeans[i] = XMeansClassifier.getK();
        }

        double[][] outputFFTValues = new double[][]{avgFFTRuntime, avgFFTK, avgFFTAccuracy, avgFFTKNNRuntime, avgFFTAccuracy, avgFFTKXmeans};
        double[][] outputPAAValues = new double[][]{avgPAARuntime, avgPAAK, avgPAAAccuracy, avgPAAKNNRuntime, avgPAAAccuracy, avgFFTKXmeans};
