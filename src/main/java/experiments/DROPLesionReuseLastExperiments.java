 ...
 */
public class DROPLesionReuseLastExperiments extends Experiment {
    public static String baseString = "src/main/java/experiments/LesionReuseLastExperiments/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (PCASkiingOptimizer.PCAAlgo algo : algos) {
            ...
            double[][] outputRuntimes = new double[][]{avgBaseRuntime, avgSampleRuntime, avgCostRuntime, avgReuseRuntime};
            double[][] outputFullRuntimes = new double[][]{avgBaseFullRuntime, avgSampleFullRuntime, avgCostFullRuntime, avgReuseFullRuntime};
            double[][] outputK = new double[][]{avgBaseK, avgSampleK, avgCostK, avgReuseK};
